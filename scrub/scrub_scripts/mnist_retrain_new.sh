#!/bin/bash
echo 'Running Scrubbing Script for Retraining MNIST...New'
...
order='Hessian'
FOCIType='full'
start_point=0 # for restarting a scrubbing run
...
outfile='results/retrain_scrub_mnist_log2nn_10000_train_pts.csv'
echo 'Using GPU '+$cuda_id
echo 'Using weight_decay '$weight_decay
